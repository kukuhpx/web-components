  ...
  for(var i = 0; i < blogPost.length; i++) {
    ...
    `<div class="blog-post">
      <div class="blog-thumbnail">
        <img src="${blogPost[i].imgURL}" alt="${'image-' + i}">
      </div>
      ...
      <div class="blog-link">
        <a href="${blogPost[i].linkURL}">Read</a>
      </div>
    </div>`;
  }
  return str;
